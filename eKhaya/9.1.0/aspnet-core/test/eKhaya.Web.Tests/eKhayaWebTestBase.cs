...
{
    public abstract class eKhayaWebTestBase : AbpAspNetCoreIntegratedTestBase<Startup>
    {
        protected static readonly Lazy<string> ContentRootFolder;

        static eKhayaWebTestBase()
        {
        ...
        protected override IWebHostBuilder CreateWebHostBuilder()
        {
            return base
                ...
                .UseSetting(WebHostDefaults.ApplicationKey, typeof(eKhayaWebMvcModule).Assembly.FullName);
        }
        ...
        {
            using (var context = IocManager.Resolve<eKhayaDbContext>())
            {
                action(context);
                context.SaveChanges();
            }
        ...
        protected async Task UsingDbContextAsync(Func<eKhayaDbContext, Task> action)
        {
            using (var context = IocManager.Resolve<eKhayaDbContext>())
            {
        ...
        protected async Task<T> UsingDbContextAsync<T>(Func<eKhayaDbContext, Task<T>> func)
        {
            T result;
