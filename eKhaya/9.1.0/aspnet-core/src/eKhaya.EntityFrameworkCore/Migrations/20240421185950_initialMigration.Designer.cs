...
namespace eKhaya.Migrations
{
    ...
    [Migration("20240421185950_initialMigration")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("eKhaya.Domain.Amenities.PropertyAmenity", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("eKhaya.Domain.Amenities.UnitAmenitity", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("eKhaya.Domain.Amenities.PropertyAmenity", b =>
                {
                    b.HasOne("eKhaya.Domain.Properties.Property", null)
                        .WithMany("Amenitity")
            ...
            modelBuilder.Entity("eKhaya.Domain.Applications.Application", b =>
                {
                    b.HasOne("eKhaya.Domain.Documents.Document", "BankStatement")
                        .WithMany()
                        .HasForeignKey("BankStatementId");

                    b.HasOne("eKhaya.Domain.Documents.Document", "ID")
                        .WithMany()
                        .HasForeignKey("Id1");

                    b.HasOne("eKhaya.Domain.Documents.Document", "Payslip")
                        .WithMany()
